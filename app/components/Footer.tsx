    ...
    <footer className="bg-gray-900 text-gray-300 py-12">
      <div className="max-w-6xl mx-auto px-6 space-y-10">
        ...
        <p className="text-xs text-gray-400 text-center max-w-3xl mx-auto">
          Este site participa de programas de afiliados, incluindo o Mercado Livre. 
          Alguns links podem gerar comissão para nós, sem custo adicional para você.
        </p>

        {/* Copyright */}
        <div className="border-t border-gray-700 pt-4 text-xs text-gray-500 text-center">
          © {new Date().getFullYear()} {NOME_LOJA} • Todos os direitos reservados.
        </div>
      </div>
    </footer>
  );
